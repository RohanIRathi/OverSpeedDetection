                ...
                if seconds <= 0.2:
                    ...
                    if flag is False:
                        ...
                        if int(speed) > speed_limit and w > 70 and h > 100:
                            cv2.putText(fr, str(int(speed))+"kmph", (x1, y1), font, 2, (255, 255, 255), 2, cv2.LINE_AA)
                            roi = fr[y-50:y + h, x:x + w]
                ...
                if seconds1 <= 0.2:
                    ...
                    if flag1 is False:
                        ...
                        if int(speed1) > speed_limit and cy1 <= 720 and w1 > 70 and h1 > 100:
                            cv2.putText(fr, str(int(speed1))+" kmph", (x1, y1), font, 2, (255, 255, 255), 2, cv2.LINE_AA)
                            roi = fr[y1-50:y1 + h1, x1:x1 + w1]
...
for la in lane_1_1:
    ...
    v+=1
for li in lane_1_2:
    cv2.imwrite('Offenders/lane2/'+str(u)+'.jpeg',li)
    u+=1
cap.release()
